...
- **The pull-down was too small to catch.** The strip along the top was 28dp; a thumb aiming at
  28dp misses. It is 56dp.
...
- **Set as default browser and Passkeys open BrightControl** when the phone has no screen for
  them, which on LightOS is always. Both settings can only be written by the shell, and
  BrightControl has one: GRANT ALL sets them.
- A report now says whether uBlock and the bridge actually installed, and what blocking was on.
